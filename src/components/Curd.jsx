            ...
            <div className="container">
                <form className="form" method='post' onSubmit={ handleSubmit }>
                    ...
                    <div className="form-control">
                        ...
                        <input type="text" name="name" onChange={ handelChange } value={user ? user.name : ""} placeholder="Enter name" />
                        <small>Error message</small>
                    </div>
                    <div className="form-control">
                        <label htmlFor="email">Email</label>
                        <input type="text" name="email" onChange={ handelChange } value={user ? user.email : ""} placeholder="Enter email" />
                        <small>Error message</small>
                    </div>
                    <div className="form-control">
                        <label htmlFor="password">Phone</label>
                        <input type="text" name="phone" onChange={ handelChange } value={user ? user.phone : ""} placeholder="Enter Phone" />
                        <small>Error message</small>
                    </div>
                    <div className="form-control">
